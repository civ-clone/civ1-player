...
const getEvents = (clientRegistry = ClientRegistry_1.instance, currentPlayerRegistry = CurrentPlayerRegistry_1.instance, engine = Engine_1.instance, ruleRegistry = RuleRegistry_1.instance) => [
    [
        'player:turn-start',
        (player) => {
