...
const getRules = (cityRegistry = CityRegistry_1.instance, ruleRegistry = RuleRegistry_1.instance) => [
    new Destroyed_1.default('civ1-player:unit/destroyed/defeat-when-no-cities', new Criterion_1.default((unit, destroyingPlayer) => cityRegistry.getByPlayer(unit.player()).length === 0
