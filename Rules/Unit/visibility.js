...
const getRules = (playerWorldRegistry = PlayerWorldRegistry_1.instance) => [
    new Visibility_1.default(new Criterion_1.default((tile, player) => !playerWorldRegistry.getByPlayer(player).includes(tile)), new Effect_1.default((tile, player) => playerWorldRegistry.getByPlayer(player).register(tile))),
];
