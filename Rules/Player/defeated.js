...
const getRules = (currentPlayerRegistry = CurrentPlayerRegistry_1.instance, playerRegistry = PlayerRegistry_1.instance, unitRegistry = UnitRegistry_1.instance, engine = Engine_1.instance) => [
    ...
    new Defeated_1.default(new Effect_1.default((player, defeatingPlayer) => unitRegistry
        .getByPlayer(player)
